        ...
        <section className="border-y border-zinc-100 bg-white py-12 overflow-hidden">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8">
              {[
                { name: 'Notion', color: 'hover:text-[#000000]', logoUrl: 'https://cdn.simpleicons.org/notion' },
                { name: 'Figma', color: 'hover:text-[#F24E1E]', logoUrl: 'https://cdn.simpleicons.org/figma' },
                { name: 'Canva', color: 'hover:text-[#00C4CC]', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/canva/canva-original.svg', fallbackLogoUrl: 'https://cdn.simpleicons.org/canva/00C4CC' },
                { name: 'Node.js', color: 'hover:text-[#339933]', logoUrl: 'https://cdn.simpleicons.org/nodedotjs' },
                { name: 'Photoshop', color: 'hover:text-[#31A8FF]', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/photoshop/photoshop-plain.svg', fallbackLogoUrl: 'https://cdn.simpleicons.org/adobephotoshop/31A8FF' },
                { name: 'Word', color: 'hover:text-[#2B579A]', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/microsoftword/microsoftword-original.svg', fallbackLogoUrl: 'https://cdn.simpleicons.org/microsoftword/2B579A' },
                { name: 'PowerPoint', color: 'hover:text-[#D24726]', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/microsoftpowerpoint/microsoftpowerpoint-original.svg', fallbackLogoUrl: 'https://cdn.simpleicons.org/microsoftpowerpoint/D24726' },
              ].map((tool, i) => (
                <motion.div
                  key={tool.name}
                  initial={{ opacity: 0, scale: 0.8 }}
                ...
                >
                  <div className="p-3 rounded-2xl bg-slate-50 border border-zinc-100 group-hover:bg-white group-hover:border-primary/20 transition-all shadow-sm group-hover:shadow-xl group-hover:shadow-primary/5">
                    <img
                      src={tool.logoUrl}
                      alt={`${tool.name} logo`}
                      className="h-8 w-8 transition-transform group-hover:rotate-[360deg] duration-1000"
                      loading="lazy"
                      onError={(event) => {
                        const target = event.currentTarget
                        const fallback = (tool as { fallbackLogoUrl?: string }).fallbackLogoUrl
